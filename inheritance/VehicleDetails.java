...
class Car extends Vehicle {
    ...
    Car(String brand, String model, int year, double basePrice, int noofdoors) {
    ...
    void calculateInsurance() {
        ...
        double insurance = 5000* basePrice + 1000 * noofdoors;
        System.out.printf("Insurance: %.2f\n", insurance);
    }

    void calcmaintainence() {
        int age = Year.now().getValue() - year;
        double maintenanceCost = 3000 * age + 500 * noofdoors;
...
public class VehicleDetails {
    public static void main(String args[]) {
        ...
        Car car = new Car(carBrand, carModel, carYear, carBasePrice, noofdoors);
